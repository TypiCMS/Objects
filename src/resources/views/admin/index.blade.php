...
<div id="table">
    ...
    <div class="table-responsive">
        @include('core::admin._v-server-table', ['url' => route('admin::index-objects')])
        {{-- For client side filtering: --}}
        {{-- @include('core::admin._v-client-table', ['data' => News::allFiltered(config('typicms.objects.select'))]) --}}
    </div>
